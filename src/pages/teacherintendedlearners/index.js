      ...
      <TeacherStructure>
        ...
        <div class="intended-learners my-5">
          ...
          <div class="intend-lrn-search mb-5 py-3">
            <button onClick={location.state?.coursedetails ? editfiles : uploadfiles} class="btn btn-dark w-50 p-2" type="submit">
              <a class="text-decoration-none text-white">{location.state?.coursedetails ? 'Edit Course' : 'Add Course heey'}</a>
            </button>
          </div>
