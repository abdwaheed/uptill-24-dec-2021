  ...
  const signin = async (e) => {
    ...
    try {
      ...
      if (auth.currentUser && !token.claims.teacher && token.claims.isActive) {
        ...
        // history.push({
        //   pathname: '/teachermainpage',
        //   state: {
        //     auth: auth.currentUser.uid,
        //     userdata: token.claims
        //   }
        // });
      }
            ...
            <div class="col-md-6 " styles="background-color: #d1d3d4;">
              ...
              <Formstructure>
                ...
                <form>
                  ...
                  <Formbutton onClick={signin} type='button' value='Adnan' className='btn login-btn w-70 mb-1 text-white' href='/forgotpassword' text='Forgot Password' />
